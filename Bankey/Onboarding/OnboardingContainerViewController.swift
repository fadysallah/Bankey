...
//  Bankey
//
//  Created by Fady Salah on 12/12/2024.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Move your money around the world quickly and easily with Bankey. ")
